...
If $H$ projected to the sphere (by straight lines toward its center) has dimension~$n$, then the claim is proved, because it is [FIXME: seems wrong!] diffeomorphic [FIXME: seems wrong!] to~$L$. [TODO: To solve this problem, consider instead of a stereographic projection a small part of the sphere with a diffeomorphism mapping straight lines to parts of big circles.]
