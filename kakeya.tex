...
\begin{thm}
\fxerror{We need to rotate the space itself to define $n$-fun\-co\-id in the rotated space.}
Let $P$ be a rotation of the space $\mathbb{R}^n$. Then
\[ \lambda i\in\{0,\dots,n-1\}:P[x_i]\in\suprel{P[f]} \Leftrightarrow x\in\suprel{f}. \]
\end{thm}
