...
We have
\[ b(c(t)) = c(t)-\frac{c(t)}{\norm{c(t)}} = \left(1-\frac{1}{\norm{c(t)}}\right)c(t) =
\left(1-\frac{1}{\sqrt{a_v^2+V_v^2 t^2}}\right)(a_v+V_v t) = \]
where $c(t)=a_v+V_v t$~is the tangent line, $V_v$ is a vector of direction of vicinity~$v$.
...
Therefore Kakeya conjecture is true.
