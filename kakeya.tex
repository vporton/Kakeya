...
By an $n$-fun\-co\-id (for a natural~$n$) we will understand a filter on the lattice~$\Gamma_n$ of finite unions of Cartesian products of $n$~sets. I will denote join and meet of funcoids in the order \emph{reverse} to set-the\-o\-re\-tic inclusion respectively as $\bigsqcup$ and $\bigsqcap$.
...
\fxwarning{Define the product of funcoids.}
