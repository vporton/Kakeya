...
Gnomonic projection (figure~\ref{fig:gnomonic}) is a projection with the projection hyperplane passes through the center of the hypersphere.
...
It is well known that Gnomonic projection maps great circles to lines (figure~\ref{fig:circles}).
