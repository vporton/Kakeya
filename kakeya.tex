...
Without loss of generality (because every rotation can be represented as a composition of rotations in a plane) we can consider only a rotation around the axes~$i=0$ and~$i=1$. Let it be rotated by the formulas ??
\end{proof}
