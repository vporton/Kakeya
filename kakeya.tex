...
[TODO: Need to prove that $n$-fun\-co\-ids are invariant regarding rotations. This is used to rotate the vicinities.]
...
By properties of $n$-fun\-co\-ids, it's evident (because it, with possible exclusion of a finite set, is mapped by~$\Pi_n$ to a funcoidal product of full-measure one-si\-de vicinities on~$\mathbb{R}$) that $\dim bH=n+1$. [TODO: Define the product of funcoids.]
