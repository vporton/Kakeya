...
\[
\begin{aligned}x_{1}&=r\cos(\varphi _{1}),\\x_{2}&=r\sin(\varphi _{1})\cos(\varphi _{2}),\\x_{3}&=r\sin(\varphi _{1})\sin(\varphi _{2})\cos(\varphi _{3}),\\&\qquad \vdots \\x_{n-1}&=r\sin(\varphi _{1})\cdots \sin(\varphi _{n-2})\cos(\varphi _{n-1}),\\x_{n}&=r\sin(\varphi _{1})\cdots \sin(\varphi _{n-2})\sin(\varphi _{n-1}).\end{aligned}
\]
