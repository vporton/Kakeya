...
\begin{claim}
(Funcoidal) join of one-si\-de vicinities of each point on $S^n\setminus\{\zeta\}$ has dimension~$n$, provided that the set of directions (measured as their ``projection'' to unit sphere) is $n$-di\-men\-sio\-nal. [FIXME: they seems to be curved.]
\end{claim}
...
Kakeya conjecture is equivalent to 

\begin{lem}
Both $\Sigma$ and $\Pi$ map $n$-dimensional sets to $n$-dimensional sets.
\end{lem}

The function $\Pi_n$ is a bijection almost everywhere (except of ).
