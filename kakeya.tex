...
\title{Proof of Kakeya's conjecture (draft)}
...
That is $b$~is a straight line passing through center~$0$ of the sphere in the direction of~$v$.

Therefore $bv$ is the vicintiy of~$0$ co-di\-rec\-ted with~$v$.
...
\begin{proof}
By the above considered diffeomorphism of polar coordinates and $K'$ being full-mea\-su\-re set, $bH$~is also a full-measure set.
\end{proof}
