...
Replace each ``curved'' vicinity $v$ by the funcoid~$h_v=z^{-1}v$  (like a ``sector'' in a hyperplane). Then take funcoidal join $H=\bigsqcup_{a\in K'}h_v$.
...
\fxwarning{Need more detailed proof.}
But $H$ has dimension~$n+1$, because it is a compact set of hyperplanes passing through the center of the hypersphere.
