...
By an $n$-fun\-co\-id we will understand a filter on the set of finite unions of $n$-cu\-bes. I will denote join and meet of funcoids in the order \emph{reverse} to set-the\-o\-re\-tic inclusion respectively as $\bigsqcup$ and $\bigsqcap$.
...
Replace each ``curved'' vicinity from point~$a$ of the hypersphere by a straight one~$h_a$ (going outside the hypersphere in~$\mathbb{R}^{n+1}$). Let $s_a$ be an ``outward'' radial vicinity of point~$a$. Then take funcoidal join $H=\bigsqcup_{a\in K_1}(h_a\sqcup s_a)$ of all these straight vicinities. $H$ is a ``swollen'' hypersphere in $\mathbb{R}^{n+1}$.
